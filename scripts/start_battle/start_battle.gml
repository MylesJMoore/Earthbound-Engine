/// @description start_battle(enemy1,enemy2,enemy3,enemy4,enemy5,Boss? 0: Normal - 1: Boss,Type? 0: Blue - 1: Green - 2: Red)
/// @param enemy1
/// @param enemy2
/// @param enemy3
/// @param enemy4
/// @param enemy5
/// @param Boss? 0: Normal - 1: Boss
/// @param Type? 0: Blue - 1: Green - 2: Red
function start_battle(argument0, argument1, argument2, argument3, argument4, argument5, argument6) {
