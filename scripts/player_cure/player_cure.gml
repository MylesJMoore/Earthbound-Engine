/// @description player_cure(player id [0 for everyone],cure ailments?,cure dead?)
/// @param player id [0 for everyone]
/// @param cure ailments?
/// @param cure dead?
function player_cure(argument0, argument1, argument2) {
	var pid, ail, rev;
	pid = argument0
	ail = argument1
	rev = argument2
