function README() {
	/*
	    This engine has been released under the CPL (Cidoku Public License). This is the text that matters, not the one included in the README script.
	    ...
	    I'm excited that you decided to use my code, so please contact me, so I can cheer you on! You don't have to contact me to ask me for permission to use it.
	    ...
	    I also want to make clear that this comes with NO WARRANTY, and it's your responsibility to learn to use my code. I'm throwing it out there AS IS. I'm pretty sure you'll figure it out,  because you're smart, and because there are plenty of examples to play around with. I'd like to thank the following people, whose code I stole. You should credit them properly too.

	    Yal, for his caterpillar movement code.
	    TheDave, for his odometer (rolling HP meter) code.
